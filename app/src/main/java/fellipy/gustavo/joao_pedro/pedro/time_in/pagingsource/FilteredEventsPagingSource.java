...
public class FilteredEventsPagingSource extends ListenableFuturePagingSource<Integer, Evento> {
    @Nullable
    ...
    public FilteredEventsPagingSource(EventosRepository eventosRepository, List<String> filtros){
    ...
    public ListenableFuture<LoadResult<Integer, Evento>> loadFuture(@NonNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Evento>> lf = service.submit(new Callable<LoadResult<Integer, Evento>>() {
            ...
            public LoadResult<Integer, Evento> call() {
                ...
                eventsList = eventosRepository.loadFilteredEvents(filtros.get(0), filtros.get(1),
                        filtros.get(2), filtros.get(3), loadParams.getLoadSize(),
                        finalOffSet);

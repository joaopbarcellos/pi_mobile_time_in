...
public class SeachedEventsPagingSource extends ListenableFuturePagingSource<Integer, Evento> {
    @Nullable
    ...
    public SeachedEventsPagingSource(EventosRepository eventosRepository, String pesquisa){
    ...
    public ListenableFuture<LoadResult<Integer, Evento>> loadFuture(@NonNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Evento>> lf = service.submit(new Callable<LoadResult<Integer, Evento>>() {
            ...
            public LoadResult<Integer, Evento> call() {
                ...
                eventsList = eventosRepository.loadSeachedEvents(pesquisa, loadParams.getLoadSize(), finalOffSet);

...
public class SportsEventsPagingSource extends ListenableFuturePagingSource<Integer, Evento> {
    @Nullable
    ...
    public SportsEventsPagingSource(EventosRepository eventosRepository, String id){
    ...
    public ListenableFuture<LoadResult<Integer, Evento>> loadFuture(@NonNull LoadParams<Integer> loadParams) {
        ...
        ListenableFuture<LoadResult<Integer, Evento>> lf = service.submit(new Callable<LoadResult<Integer, Evento>>() {
            ...
            public LoadResult<Integer, Evento> call() {
                ...
                eventsList = eventosRepository.loadSportsEvents(id_classificacao, loadParams.getLoadSize(), finalOffSet);
